...
/**
 * Sends a welcome email to the guest
 */
export async function sendWelcomeEmail({ response }: SendWelcomeEmailParams) {
  if (!response.email) {
  ...
  const emailHtml = `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <title>Welcome to Kaushal & Priyanka's Wedding!</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f5f5f5;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f5f5f5">
        <tr>
            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 90%;">
              ...
              <tr>
                <td align="center" style="background: linear-gradient(135deg, #4a6fa5 0%, #e91e63 100%); padding: 40px 20px;">
                  ...
                  <p style="color: white; margin: 10px 0 0; font-size: 16px;">Join us for Kaushal & Priyanka's Wedding Celebration</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 30px;">
                  <p style="font-size: 16px; line-height: 1.5; color: #333; margin-top: 0;">Dear <strong>${response.name}</strong>,</p>
                  <p style="font-size: 16px; line-height: 1.5; color: #333;">We're thrilled to invite you to our wedding celebration! We would be honored to have you join us for this special occasion. Below are the details of the events you're invited to:</p>
                  ...
                  <!-- RSVP button -->
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${rsvpLink}" style="display: inline-block; background-color: #e91e63; color: white; text-decoration: none; padding: 12px 25px; border-radius: 4px; font-weight: bold; font-size: 16px;">
                      RSVP Now
                    </a>
                  </div>
                  
                  <p style="font-size: 16px; line-height: 1.5; color: #333;">Please RSVP by February 15, 2025 to help us with our planning. If you have any questions, please don't hesitate to reach out to us.</p>
                  <p style="font-size: 16px; line-height: 1.5; color: #333;">We look forward to celebrating with you!</p>
                  <p style="font-size: 16px; line-height: 1.5; color: #333; margin-bottom: 0;">Warm regards,<br>Kaushal & Priyanka Subedi</p>
                </td>
              </tr>
  ...
  try {
    const { data, error } = await resend.emails.send({
      from: "Kaushal & Priyanka <wedding@kaushalandpriyanka.love>",
      to: [response.email],
      subject: "You're Invited to Kaushal & Priyanka's Wedding!",
      html: emailHtml,
    });
